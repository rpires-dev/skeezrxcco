...
<div id="comment-{{ $comment->getKey() }}" class="column large-12">
    @else
    <li id="comment-{{ $comment->getKey() }}" class="media">
        ...
        <ol class="commentlist">
            <li class="thread-alt depth-1 comment">
                <div class="avatar">
                    <img class="avatar" src="/storage/{{$comment->commenter->avatar ?? 'profile.png'}}"
                        alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" style="
            width: 50px;height: 50px;border-radius: 48px;object-fit: cover;">
                </div>
                            ...
                            <div class="modal-content">
                                <form method="POST" action="{{ route('comments.update', $comment->getKey()) }}">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit"
                                            class="btn btn-sm btn-outline-success text-uppercase">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
